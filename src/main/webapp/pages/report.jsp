...
<div class="downloadfile">
<ul>
	<li><img src="${pageContext.request.contextPath }/imgs/pdf.png" /><a href="reportYfkpdf.action?startTime=<s:date name="startTime" format="yyyy-MM-dd"/>&endTime=<s:date name="endTime"  format="yyyy-MM-dd"/>">PDF下载</a></li>
	<li><img src="${pageContext.request.contextPath }/imgs/excel.png" /><a href="reportYfke.action?startTime=<s:date name="startTime" format="yyyy-MM-dd"/>&endTime=<s:date name="endTime"  format="yyyy-MM-dd"/>">Excel下载</a></li>
</ul>
</div>
<h1>预付款流水报表</h1>
<table>
...
<div class="downloadfile">
<ul>
	<li><img src="${pageContext.request.contextPath }/imgs/pdf.png" /><a href="reportdlspdf.action?startTime=<s:date name="startTime" format="yyyy-MM-dd"/>&endTime=<s:date name="endTime"  format="yyyy-MM-dd"/>">PDF下载</a></li>
	<li><img src="${pageContext.request.contextPath }/imgs/excel.png" /><a href="reportdlse.action?startTime=<s:date name="startTime" format="yyyy-MM-dd"/>&endTime=<s:date name="endTime"  format="yyyy-MM-dd"/>">Excel下载</a></li>
</ul>
</div>
<h1>代理商流水报表</h1>
<table>
